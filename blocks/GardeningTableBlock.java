...
import com.belgieyt.morefeatures.items.FoodItems;
...
public class GardeningTableBlock extends Block implements ISidedInventoryProvider {
    ...
    public static void init() {
            ...
            registerCompostable(0.3F, ItemInit.MAGENTA_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.ORANGE_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.LIGHT_BLUE_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.LIGHT_GRAY_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.GRAY_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.BLUE_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.CYAN_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.RED_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.PINK_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.PURPLE_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.BLACK_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.WHITE_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.YELLOW_LEAVES_ITEM.get());
        registerCompostable(0.3F, ItemInit.BROWN_LEAVES_ITEM.get());
        registerCompostable(0.65F, ItemInit.MILK_CUP_ITEM.get());
        registerCompostable(0.65F, ItemInit.LAVENDER_ITEM.get());
        registerCompostable(0.65F, ItemInit.MAGENTA_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.PINK_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.PURPLE_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.BLUE_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.CYAN_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.LIGHT_BLUE_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.BLACK_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.WHITE_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.BROWN_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.GRAY_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.LIGHT_GRAY_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.YELLOW_ROSE_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.ORANGE_ROSE_BUSH_ITEM.get());
        registerCompostable(0.9F, ItemInit.MOON_FLOWER_ITEM.get());
        registerCompostable(0.65F, ItemInit.STRAWBERRY_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.KIWI_VINES_ITEM.get());
        registerCompostable(0.65F, ItemInit.STRAWBERRY_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.LEMON.get());
        registerCompostable(0.65F, ItemInit.MANGO_BLOCK_ITEM.get());

        registerCompostable(0.65F, ItemInit.BLACKBERRY_BUSH_ITEM.get());
        registerCompostable(0.65F, ItemInit.BLUEBERRY_BUSH_ITEM.get());
        registerCompostable(0.85F, ItemInit.FLOWER_O_POISON_ITEM.get());
        registerCompostable(0.85F, ItemInit.FLOWER_O_HEALING_ITEM.get());
        registerCompostable(0.85F, ItemInit.ASH_MUSHROOM_ITEM.get());


        registerCompostable(0.5F, ItemInit.LIGHT_BLUE_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.BLUE_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.YELLOW_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.BLACK_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.WHITE_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.BROWN_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.GRAY_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.LIGHT_GRAY_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.PINK_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.PURPLE_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.MAGENTA_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.ORANGE_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.RED_VINE_ITEM.get());
        registerCompostable(0.5F, ItemInit.CYAN_VINE_ITEM.get());

        registerCompostable(0.5F, ItemInit.YELLOW_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.BLACK_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.WHITE_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.PINK_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.ORANGE_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.BROWN_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.GRAY_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.LIGHT_GRAY_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.PURPLE_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.MAGENTA_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.BLUE_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.LIGHT_BLUE_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.CYAN_LEAVE_CARPET_ITEM.get());
        registerCompostable(0.5F, ItemInit.RED_LEAVE_CARPET_ITEM.get());
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        ...
        public static BlockState empty(BlockState state, World world, BlockPos pos) {
            if (!world.isRemote) {
                ...
                ItemEntity itementity = new ItemEntity(world, (double)pos.getX() + d0, (double)pos.getY() + d1, (double)pos.getZ() + d2, new ItemStack(ItemInit.MOSS_BLOCK_ITEM.get()));
        ...
        public ISidedInventory createInventory(BlockState state, IWorld world, BlockPos pos) {
            int i = state.get(LEVEL);
            if (i == 8) {
                return new GardeningTableBlock.FullInventory(state, world, pos, new ItemStack(ItemInit.MOSS_BLOCK_ITEM.get()));
            } else {
        ...
        static class FullInventory extends Inventory implements ISidedInventory {
             ...
             */
            public boolean canExtractItem(int index, ItemStack stack, Direction direction) {
                return !this.extracted && direction == Direction.DOWN && stack.getItem() == ItemInit.MOSS_BLOCK_ITEM.get();
            }
        ...
        static class PartialInventory extends Inventory implements ISidedInventory {
             ...
             */
            public boolean canInsertItem(int index, ItemStack itemStackIn, @Nullable Direction direction) {
                return !this.inserted && direction == Direction.UP && GardeningTableBlock.CHANCES.containsKey(itemStackIn.getItem());
            }
