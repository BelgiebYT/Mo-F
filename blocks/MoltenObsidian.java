...
public class MoltenObsidian extends Block {

    public MoltenObsidian(AbstractBlock.Properties properties) {
        super(properties);
    }
        ...
        if (rand.nextInt(5) == 0) {
            ...
            if (direction != Direction.UP) {
                ...
                if (!stateIn.isSolid() || !blockstate.isSolidSide(worldIn, blockpos, direction.getOpposite())) {
                    ...
                    worldIn.addParticle(ParticleTypes.DRIPPING_LAVA, (double)pos.getX() + d0, (double)pos.getY() + d1, (double)pos.getZ() + d2, 0.0D, 0.0D, 0.0D);
                }
            }
        }
    }
