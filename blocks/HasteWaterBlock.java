...
public class HasteWaterBlock extends FlowingFluidBlock {

    public HasteWaterBlock(java.util.function.Supplier<? extends FlowingFluid> supplier) {
    ...
    public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
        if (!worldIn.isRemote) {
            if (entityIn instanceof LivingEntity) {
                ...
                livingentity.addPotionEffect(new EffectInstance(Effects.HASTE, 40));
            }
        }
